...
class UserRepository extends Repository
{
    ...
    public function updateUser($id, User $user)
    {
        try {
            ...
            $stmt = $this->connection->prepare("UPDATE User SET first_name = :first_name, last_name = :last_name, username = :username, email = :email, password = :password, is_admin = :is_admin, profile_picture = :profile_picture, user_type = :user_type WHERE id = :id");
            $stmt->bindParam(':first_name', $user->first_name);
            $stmt->bindParam(':last_name', $user->last_name);
            $stmt->bindParam(':username', $user->username);
            $stmt->bindParam(':email', $user->email);
